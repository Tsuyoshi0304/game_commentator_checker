...
Commentator.seed do |s|
  s.id = 15
  s.name = "はじめしゃちょー2"
  s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open(Rails.root.join("app/assets/images/hazime-syacho.jpeg")),
                                                          filename: "hazime-shacho.jpeg")
...
Commentator.seed do |s|
  ...
  s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open(Rails.root.join("app/assets/images/jacksepticeye.jpeg")),
                                                          filename: "jacksepticeye.jpeg")
...
Commentator.seed do |s|
  s.id = 35
  s.name = "たくっち"
  s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open(Rails.root.join("app/assets/images/takutti.jpeg")), filename: "takutti.jpeg")
...
Commentator.seed do |s|
  s.id = 36
  s.name = "マミルトン"
  s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open(Rails.root.join("app/assets/images/mamiruton.jpeg")), filename: "mamiruton.jpeg")
...
Commentator.seed do |s|
  s.id = 37
  s.name = "明日香ちゃんねる"
  s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open(Rails.root.join("app/assets/images/asuka.jpeg")), filename: "asuka.jpeg")
...
Commentator.seed do |s|
  ...
  s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open(Rails.root.join("app/assets/images/chachacha.jpeg")), filename: "chachacha.jpeg")
...
Commentator.seed do |s|
  s.id = 39
  s.name = "kson ONAIR"
  s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open(Rails.root.join("app/assets/images/kson.jpeg")), filename: "kson.jpeg")
