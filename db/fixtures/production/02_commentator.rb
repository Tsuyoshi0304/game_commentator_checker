...
Commentator.seed do |s|
  ...
  s.appearance = 1
	...
	Commentator.seed do |s|
		s.id = 11
		s.name = 'ポッキー'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/pocky.jpeg'), filename: 'pocky.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 12
		s.name = 'ヒカキン'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/hikakin.jpeg'), filename: 'hikakin.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 13
		s.name = 'セイキン'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/seikin.jpeg'), filename: 'seikin.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 14
		s.name = 'カズゲームズ'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/kazu.jpeg'), filename: 'kazu.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 15
		s.name = 'はじめしゃちょー2'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/hazime-syacho.jpeg'), filename: 'hazime-shacho.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 16
		s.name = '兄者弟者'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/anioto.jpeg'), filename: 'anioto.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 17
		s.name = '日常組'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/nitizyou.jpeg'), filename: 'nitizyou.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 18
		s.name = '兎田ぺこら'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/pekora.jpeg'), filename: 'pekora.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 19
		s.name = 'しゅうゲームズ'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/syugames.jpeg'), filename: 'syugames.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 20
		s.name = 'キズナアイ'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/kizunaai.jpeg'), filename: 'kizunaai.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 21
		s.name = '花江夏樹'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/hanaenatsuki.jpeg'), filename: 'hanaenatsuki.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 22
		s.name = 'わいわい'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/waiwai.jpeg'), filename: 'waiwai.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 23
		s.name = 'ホラフキン'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/horahukin.jpeg'), filename: 'horahukin.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 24
		s.name = 'KUN'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/KUN.jpeg'), filename: 'KUN.jpeg' )
	...
	Commentator.seed do |s|
		s.id = 25
		s.name = 'PewDiePie'
		s.youtube_icon = ActiveStorage::Blob.create_and_upload!(io: File.open('./app/assets/images/PewDiePie.jpeg'), filename: 'PewDiePie.jpeg' )
